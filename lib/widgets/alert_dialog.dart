  ...
  Widget build(BuildContext context) {
    ...
    if (title != null) {
      children.add(new Padding(
        padding:
            titlePadding ?? new EdgeInsets.fromLTRB(24.0, 24.0, 24.0, content == null ? 20.0 : 0.0),
      ...
      switch (defaultTargetPlatform) {
        case TargetPlatform.iOS:
          label = semanticLabel ?? CupertinoLocalizations.of(context)?.alertDialogLabel;
          break;
    ...
    return new Dialog(child: dialogChild, shape: shape);
  }
}
